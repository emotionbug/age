...
require 'GHD Mode: general GHD' 'general GHD mode'
require 'GHD General Decomposition: true' 'general GHD decomposition disclosure'
require 'GHD Fallback Reason: none' 'GHD fallback reason'
require 'GHD Separator Count: 3' 'pair plus multi-tail separator count'
require 'GHD Separators: .*pair v.*provider .*provider ' 'pair and leaf-tail separator disclosure'
require 'GHD Separator Domain Keys: [1-9][0-9]*' 'multi-tail separator domains'
require 'Yannakakis Step Filter Mode: planned step-domain provider filter' 'planned tail pruning filter'
require 'Yannakakis Bottom-Up Rows Removed: [1-9][0-9]*' 'planned bottom-up pruning'
require 'GHD Cyclic Core Rows Removed: [0-9]+' 'cyclic core pruning disclosure'

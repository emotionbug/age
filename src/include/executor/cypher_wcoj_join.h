...
#define AGE_WCOJ_PROGRESSIVE_MIN_SEED_POSTINGS 1024
#define AGE_WCOJ_PROGRESSIVE_MAX_SEED_POSTINGS 65536
#define AGE_WCOJ_PROGRESSIVE_MIN_SKEW_RATIO 8.0
#define AGE_WCOJ_LEAPFROG_MAX_SKEW_RATIO 4.0
...
typedef enum AgeWCOJJoinPrivateField
{
    ...
    AGE_WCOJ_JOIN_PRIVATE_ROW_GOAL_SOURCE,
...
typedef enum AgeWCOJConsumerKind
{
    ...
    AGE_WCOJ_CONSUMER_DISTINCT_KEY,
    AGE_WCOJ_CONSUMER_GROUP_COUNT,
    AGE_WCOJ_CONSUMER_SUM_PROPERTY,
    AGE_WCOJ_CONSUMER_GROUP_SUM_PROPERTY,
    AGE_WCOJ_CONSUMER_EXISTS,
    AGE_WCOJ_CONSUMER_GROUP_COUNT_DISTINCT_KEY,
    AGE_WCOJ_CONSUMER_MIN_PROPERTY,
    AGE_WCOJ_CONSUMER_MAX_PROPERTY,
    AGE_WCOJ_CONSUMER_GROUP_MIN_PROPERTY,
    AGE_WCOJ_CONSUMER_GROUP_MAX_PROPERTY,
    AGE_WCOJ_CONSUMER_AVG_PROPERTY,
    AGE_WCOJ_CONSUMER_GROUP_AVG_PROPERTY
} AgeWCOJConsumerKind;

typedef enum AgeWCOJRowGoalSource
{
    AGE_WCOJ_ROW_GOAL_NONE = 0,
    AGE_WCOJ_ROW_GOAL_LIMIT,
    AGE_WCOJ_ROW_GOAL_EXISTS
} AgeWCOJRowGoalSource;

typedef enum AgeWCOJSumPropertyDescField
{
    AGE_WCOJ_SUM_PROPERTY_PROVIDER_INDEX = 0,
    AGE_WCOJ_SUM_PROPERTY_KEY,
    AGE_WCOJ_SUM_PROPERTY_COUNT
} AgeWCOJSumPropertyDescField;
...
typedef enum AgeWCOJProviderDescField
{
    ...
    AGE_WCOJ_PROVIDER_DESC_SOURCE_RTI,
    AGE_WCOJ_PROVIDER_DESC_SOURCE_CORRELATION_GROUP,
    AGE_WCOJ_PROVIDER_DESC_OUTPUT_MAP,
    AGE_WCOJ_PROVIDER_DESC_FETCH_PROPERTIES,

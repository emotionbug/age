...
typedef struct VLEContextTraversalRootState
{
    ...
    VLEMatrixFrontierCache *matrix_frontier_cache;
...
typedef struct VLEContextSourceCursor
{
    ...
    AgeVLEMatrixFrontierCursorPolicy matrix_policy;

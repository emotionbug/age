...
typedef struct AgeVLESourceStats
{
    ...
    int64 matrix_frontier_source_run_raw_block_batches;
    int64 matrix_frontier_source_run_raw_block_batch_cursors;
    int64 matrix_frontier_source_run_block_tag_batches;
    int64 matrix_frontier_source_run_block_tag_batch_cursors;
    int64 matrix_frontier_source_run_block_tag_batch_positions;
    int64 matrix_frontier_source_run_replay_segments;
    int64 matrix_frontier_source_run_replay_segment_sources;
    int64 matrix_frontier_source_run_replay_segment_max;
    int64 matrix_frontier_source_run_seed_groups;
    int64 matrix_frontier_source_run_seed_group_cursors;
    int64 matrix_frontier_source_run_shared_page_groups;
    int64 matrix_frontier_source_run_shared_page_cursors;
    int64 matrix_frontier_source_run_shared_page_run_block_groups;
    int64 matrix_frontier_source_run_shared_page_run_block_cursors;
    int64 matrix_frontier_source_run_shared_page_run_block_intersections;
    int64 matrix_frontier_source_run_shared_page_run_block_intersection_cursors;
    int64 matrix_frontier_source_run_shared_page_run_block_intersection_skips;
    int64 matrix_frontier_source_run_shared_page_run_block_direct_seeds;
    int64 matrix_frontier_source_run_shared_page_run_block_direct_seed_cursors;
    int64 matrix_frontier_source_run_shared_page_run_block_streams;
    int64 matrix_frontier_source_run_shared_page_run_block_stream_cursors;
    int64 matrix_frontier_source_run_shared_page_run_block_stream_positions;
    int64 matrix_frontier_source_run_shared_page_run_block_full_group_drains;
    int64 matrix_frontier_source_run_shared_page_run_block_full_group_drain_cursors;
    int64 matrix_frontier_source_run_shared_page_fallbacks;
    int64 matrix_frontier_source_run_fallback_regroups;
    int64 matrix_frontier_source_run_fallback_regroup_cursors;

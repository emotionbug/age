...
BEGIN
    ...
    IF NOT property_direct OR NOT property_batched OR
       ...
       NOT property_rejects OR NOT property_combinations THEN
    ...
    IF NOT factorized_source_rows OR NOT factorized_keys OR
       NOT factorized_builds OR NOT factorized_combinations THEN
...
BEGIN
    ...
    IF NOT has_one_block OR NOT has_three_batches OR
       NOT has_three_source_keys OR NOT has_forty_eight_restarts_avoided OR
       NOT has_fifty_one_payload_rows THEN
